...
void Models::AddModel(const std::string& name, const std::string& modelPath, const std::string& textPath)
{
...
void Models::DrawModel(const std::string& name, const TransForm& trans)
{
